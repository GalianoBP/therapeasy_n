...
import 'package:therapeasy/db_calls.dart';
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    RichText(
                                        text: TextSpan(
                                            text:
                                                "Al momento hai ${Appuser.ther.length} terapie attive e devi assumere ${Appuser.pending_med.length} medicine",
                                            style: const TextStyle(
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                    ...
                                    child: Icon(
                                        ...
                                        color: (Appuser.pending_med.isEmpty)
                                            ? Colors.greenAccent
                                            : Colors.redAccent,
                                        size: 40)),
                              ],
