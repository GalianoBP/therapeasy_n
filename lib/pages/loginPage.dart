                  ...
                  Padding(
                      ...
                      child: SizedBox(
                          ...
                          child: TextFormField(
                              ...
                              onFieldSubmitted: (String a) => {_login()},
                              decoration: InputDecoration(
                                hintText: 'password',
                                hintStyle:
                                    const TextStyle(fontFamily: 'VeganStyle'),
  ...
  Future<void> _login() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            ...
            content: Text('Sto contattando il server...')),
      );
    }
    ...
    if (await logged) {
      ...
      Future.delayed(Duration.zero, () {
        Navigator.pushNamedAndRemoveUntil(context, go, (route) => false);
      });
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            ...
            content: Text('Credenziali errate o sessione già attiva')),
      );
    }
  }
}
